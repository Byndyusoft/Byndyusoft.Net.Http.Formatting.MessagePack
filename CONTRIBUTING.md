# Contributing to Byndyusoft.Net.Http.Formatting.MessagePack
...
If you want to fix, to add enhancement, or to improve documentation, you need to learn how to work with GitHub, Byndyusoft.Net.Http.Formatting.MessagePack code base and contributing rules.
...
```shell
 git clone https://github.com/Byndyusoft/Byndyusoft.Net.Http.Formatting.MessagePack.git
```
